...
/// - 免费兜底线路统一叫「内置免费引擎」，其空态展示名是「内置公共翻译」，
///   隐私语境必须说明它是<b>联网</b>的公共服务；
...
internal static class EngineWording
{
    ...
    /// <summary>空态/向导中对同一条免费线路的展示名。</summary>
    public const string FreePublicTranslationName = "内置公共翻译";
    ...
    public const string FreeEngineOnlineServiceNote =
        "内置免费引擎是联网的公共翻译服务：待翻译文字会发送到公共服务完成翻译。" +
        "只发送待翻译文字，不发送截图、历史记录或 API Key。";
