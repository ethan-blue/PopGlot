...
> 生效日期：2026-08-31。当前版本：**0.1.5**。
> 0.1.6 候选改动（Prompt 个性化闭环、会话暂存接续等）已在主干工作树实现，但版本号尚未提升、未打 tag；对应条目暂记于 [CHANGELOG.md](../CHANGELOG.md) 的「未发布（Unreleased）」小节，发布时按下方清单提升至 0.1.6。
